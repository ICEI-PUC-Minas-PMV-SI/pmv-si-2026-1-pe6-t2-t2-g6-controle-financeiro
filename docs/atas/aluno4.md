...
|:-------:|:---------------:|:--------:|:------------------:|:-------------------:|
| 09/02 - 15/02 | Gestão de Serviços de TI - Unidade 1 | ✅ | Definição do tema | Definição do tema |
| 16/02 - 22/02 | Gestão de Serviços de TI - Unidade 2 | ✅ | Definição do tema | Definição do tema |
| 23/02 - 01/03 | Arquitetura de Software Distribuído - Unidade 1 e 2 | ✅ | Definir escopo da documentação com a equipe | Definir escopo da documentação com a equipe |
| 02/03 - 08/03 | Arquitetura de Software Distribuído - Unidade 3 | ✅ | Revisão da documentação | Revisão da documentação |
...
| 18/05 - 24/05 | Fundamentos de Projeto e Análise de Algoritmos - Unidade 1 | ✅ | Desenvolvimento Mobile | Configuração do SDK do Expo e resolução de conflitos para compatibilidade com o Expo Go |
